...
export default function RecommendationsPage() {
  ...
  const saveRecommendations = usePersonalityStore((s) => s.setRecommendations);
  const lastRecommendations = usePersonalityStore((s) => s.lastRecommendations);

  const lastRecsRef = useRef(lastRecommendations);
  useEffect(() => { lastRecsRef.current = lastRecommendations; }, [lastRecommendations]);
  ...
  }, [personality, medium, mood, saveRecommendations]);
  ...
  return (
    <AppLayout>
      <div className="mb-6">
        ...
        <p className="text-muted text-[15px] mt-1.5">Books, films, music, and activities matching your personality profile.</p>
      </div>
